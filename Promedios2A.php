...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    foreach ($_POST['rice'] as $index => $rice) {
        ...
        VALUES ('$rice', 'nombre', 2, 'A', $espanol_b1, $espanol_b2, $espanol_b3, $espanol_b4, $espanol_b5, $espanol_b6, $mate_b1, $mate_b2, $mate_b3, $mate_b4, $mate_b5, $mate_b6, $ingles_b1, $ingles_b2, $ingles_b3, $ingles_b4, $ingles_b5, $ingles_b6, $promedio_bloque1, $promedio_bloque2, $promedio_bloque3, $promedio_bloque4, $promedio_bloque5, $promedio_bloque6, $promedio_general)
...
WHERE a.grado = 2 AND a.seccion = 'A'";
...
<br>
    ...
    <h2>Captura de Calificaciones - 2A</h2>
    <hr>
